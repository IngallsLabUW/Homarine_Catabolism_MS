# Purpose: Quality control on all targeted datasets for the G5 Metabolomics

# History:
# Date	     Remarks
# 20240528   K Heal changing to work with G5 data
...
outer_file_loc <- here("data", "raw", "metabolomics", "G5", "particulate", "mzml")
save_dir <- here("data", "intermediate", "metabolomics", "g5", "targeted")
...
QE_QC(
  dat_filename = here(
    outer_file_loc,
    "HILIC_positive",
    "HILIC_QE_POS_G5_homarine_incubations.csv"
  ),
  std_flag <- NA,
  blank_flag <- "_Blk_Blk_",
  sn_min = 3,
