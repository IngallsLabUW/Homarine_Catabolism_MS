...
dat_loc <- normalizePath("data/raw/genomes/ncbi_metadata/missing_accession_downloads/")
...
# Save the output ----
write_csv(biosample_data_sub, here("data", "intermediate", "ncbi_metadata_biosample_info_missing_assemblies.csv"))

# Show completion message
print(paste("Processing complete. Output saved to:", here("data", "intermediate", "ncbi_metadata_biosample_info_missing_assemblies.csv")))
