...
library(integral)
library(janitor)
source("02_untargeted/untargeted_dataprocessing_fxns.R")


# BMIS on HILIC particulate ------
## Perform BMIS ----
BMIS_results_hp <- BMIS_MSdialoutput(
  dat1_filename = "02_untargeted/intermediates/HILICparticulate_wide_adducts.csv",
  sample_key = "raw_input/sample_key.csv",
  is_names_filename = "raw_input/is_names_particulate.csv",
  is_dat1_filename = "raw_input/particulate/skyline/HILIC_Pos_Particulate_OscarSosaBacteria_ReDo.csv",
  is_dat2_filename = "raw_input/particulate/skyline/HILIC_Neg_Particulate_OscarSosaBacteria.csv",
  cut_off1 = 0.2,
  cut_off2 = 0.1,
  smps_to_dump = c(
...
BMIS_results_hd <- BMIS_MSdialoutput(
  dat1_filename = "02_untargeted/intermediates/HILICdissolved_wide_adducts.csv",
  sample_key = "raw_input/sample_key.csv",
  is_names_filename = "raw_input/is_names_dissolved.csv",
  is_dat1_filename = "raw_input/dissolved/skyline/HILIC_Pos_Dissolved_OscarSosaBacteria_zerod.csv",
  is_dat2_filename = "raw_input/dissolved/skyline/HILIC_Neg_Dissolved_OscarSosaBacteria_zerod.csv",
  cut_off1 = 0.2,
  cut_off2 = 0.1,
  smps_to_dump = c(),
  is_to_dump = c()
...
## Save output ----
### Internal standard reps -----
ggsave("02_untargeted/intermediates/BMIS_checks/HILIC_Dissolved_ISreps.pdf",
       BMIS_results_hd[[1]],
       width = 15, height = 8, units = "in")

### Quick report -----
writeLines(BMIS_results_hd[[2]], "02_untargeted/intermediates/BMIS_checks/HILIC_Dissolved_BMISSummary.txt")

### Internal standard reps -----
ggsave("02_untargeted/intermediates/BMIS_checks/HILIC_Dissolved_ISvIScheck.pdf",
       BMIS_results_hd[[3]],
       width = 10, height = 8, units = "in")

### BMIS output -----
write_csv(BMIS_results_hd[[4]],
          "02_untargeted/intermediates/BMISd_HILIC_Dissolved.csv")
