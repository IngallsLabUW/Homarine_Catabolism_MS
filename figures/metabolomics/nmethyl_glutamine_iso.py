...
for atom in mol.GetAtoms():
    ...
    if atom.GetSymbol() == "C":
        ...
        # Nitrogen orange (#F28E2B) - only if it has 2 carbon neighbors
...
# Save to file
drawer.WriteDrawingText("figures/structures/nmethyl_glutamine_isotopologue.png")
print("Image saved as nmethyl_glutamine_isotopologue.png")